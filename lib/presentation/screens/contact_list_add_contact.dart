...
class ContactListAddContactPage extends StatefulWidget {
  const ContactListAddContactPage({super.key});

  @override
  State<ContactListAddContactPage> createState() =>
      ContactListAddContactState();
}

class ContactListAddContactState extends State<ContactListAddContactPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text("Estate Management - Add Contact")),
